...
public class RDDetailsPO  extends TestBase{
	...
	By 
	User_Details,Switch_User,logout_IPT,Shikeisho_Number_Nav,Shikeisho_Number_Header,Shikeisho_Number,Subject,
	...
	Part_Status,Pagination_Page,Previous_Page,	Next_Page;
	...
	public void loadRDDetailsPO() throws Exception {
		oJsOR_Reg = oComUtil.ReadJsonFileGetJsonObject(System.getProperty("user.dir") + "/src/objectRepo/locators_RDDetailScreen.json");
